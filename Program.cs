...
namespace mainFile
{
    public class Game : GameWindow
    {
        ...
        protected override void OnRenderFrame(FrameEventArgs args)
        {
            ...
            Matrix4 model = Matrix4.CreateRotationY(MathHelper.DegreesToRadians(spinnyvalue)) * Matrix4.CreateRotationX(MathHelper.DegreesToRadians(spinnybutx));
